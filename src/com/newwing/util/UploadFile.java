...
public class UploadFile {
	...
	public static String uploadFile(HttpServletRequest request, MultipartFile uploadFile, String projectNo, String originalFilename) {
		try {
			...
			if (null != uploadFile && !"".equals(uploadFile)) {
				...
				//获取生成的日期目录
				String dir = makeChildDirectory(storeDirectory);
				//指定文件上传的最终目录
...
//				backPath = "/uploadFiles/" + projectNo + "/" + dir + "/" + originalFilename;
	...
	//创建一个以日期命名的上传文件目录
	private static String makeChildDirectory(String storeDirectory) {
