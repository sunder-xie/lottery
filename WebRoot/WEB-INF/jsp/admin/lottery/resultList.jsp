	...
	<body id="wrapper">
		<div class="container-fluid animated bounceIn cardBg" id="main-container" >
			<div id="page-content" class="clearfix " style="background:#fff;margin:20px 31px; padding-top: 0px">
				<h2>最终结果：【${resultList.size()}】场有效</h2>
				<div class="row-fluid">
					<div class="row-fluid">
						<form id="userCriteriaQuery" method="post" action="queryResultList.do">
<!-- 							<a class='btn btn-mini btn-info btn-rbg' style="margin-top:0"  href="calculate.do">自动计算</a> -->
							...
							<table id="table_report" class="table table-striped table-bordered table-hover"
		                    	...
		                    	<thead>
		                    		<tr>
										...
										<th class="center" colspan="4">让球</th>
										<th class="center" colspan="4">大小</th>
				                    	...
				                    	<tbody>
				                        	<c:forEach items="${resultList}" var="result" varStatus="vs">
				                            	<tr class="odd gradeX">
													...
													<td class="center">${result.wholeRangqiu}</td>
													<td class="center"><c:if test="${result.saishi == 'BEWIN'}"><p style="color:red;"></c:if>${result.wholeRangqiu1}<c:if test="${result.saishi == 'BEWIN'}"></p></c:if></td>
													<td class="center"><c:if test="${result.saishi == 'JINSHA'}"><p style="color:red;"></c:if>${result.wholeRangqiu2}<c:if test="${result.saishi == 'JINSHA'}"></p></c:if></td>
													<td class="center">${result.jieguoWhole}</td>
