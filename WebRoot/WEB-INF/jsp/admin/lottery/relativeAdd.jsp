	...
	<body id="wrapper">
		<div class="container-fluid animated bounceIn cardBg" id="main-container" >
			<div id="page-content" class="clearfix " style="background:#fff;margin:20px 31px; padding-top: 0px">
				...
				<div class="row-fluid">
					<div class="row-fluid">
						<form id="userCriteriaQuery" method="post" action="addRelative.do" >
							<table id="table_report" class="table table-striped table-bordered table-hover"
									style="margin:10px 0 0 0; padding-top: 0px">
				                <tbody>
				                	<tr class="odd gradeX">
				                    	<td class="center">必赢球队名称：</td>
										<td class="center"><input type="text" name ="qiuduiBewin" /></td>
			                    	</tr>
			                    	<tr class="odd gradeX">
				                    	<td class="center">金沙球队名称：</td>
										<td class="center"><input type="text" name ="qiuduiJinsha" /></td>
			                    	</tr>
			                    	<tr class="odd gradeX">
